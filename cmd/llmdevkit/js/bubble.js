...
export function bubbleHTML(cls, label, content, raw, collapsed, brief, timestamp, tokenCount) {
    ...
    switch (cls) {
        case 'system':
            cardCls += ' border-secondary fst-italic';
        ...
        case 'llm':
            break;
        case 'thinking':
            cardCls += ' border-secondary border-dashed bg-transparent';
            break;
        case 'tool-req':
            cardCls += ' border-start border-warning';
            maxW = '90%';
            break;
        case 'tool-resp':
            cardCls += ' border-start border-success';
            maxW = '90%';
            break;
        case 'file-changes':
            cardCls += ' border-dark';
            ...
            break;
        case 'error':
            cardCls += ' border-danger text-danger';
            align = 'align-self-center';
            maxW = '90%';
            break;
    }
